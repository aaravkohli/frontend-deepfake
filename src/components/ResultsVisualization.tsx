...
import { DetectionResponse, DetectionResult, FileType } from '../types/api';
...
function getResultIcon(result: DetectionResult, size = 24) {
  switch (result) {
...
function getResultColor(result: DetectionResult) {
  switch (result) {
    case DetectionResult.REAL:
      return 'success';
    case DetectionResult.FAKE:
...
function getFileTypeIcon(fileType: FileType, size = 20) {
  switch (fileType) {
    case FileType.AUDIO:
...
export default function ResultsVisualization({ result, className = '' }: ResultsVisualizationProps) {
